...
public class Anfibio extends Animal {
    ...
    // Construtor da classe com os atributos próprios e atributos herdados, os quais
    // são chamados atravez do super;
    public Anfibio(int id, String nome, String especie, int andarDesejado,
            int peso, int temperaturaIdeal) {
        super(id, nome, especie, andarDesejado, peso, temperaturaIdeal);
    }

    // Métodos de andar e nadar do anfibio;
    ...
    // Depois ele verifica se o objeto passado é uma instância da classe Anfibio ou

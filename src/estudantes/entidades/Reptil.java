...
/**
 * Classe Retil que é um tipo de animal
 */
public class Reptil extends Animal {
    /**
     * Limite de paciência dr um Retil esperando na fila
     * em segundos
     */
    public int PACIENCIA_MAXIMA = 10;

    /**
     * Construtor completo da classe Reptil
    ...
    /**
     * Método que retorna se o Reptil está andando
     * 
     * @return andando
     */
     ...
     * Depois ele verifica se o objeto passado é uma instância da classe Reptil ou
     ...
     * superclasse.
     * Depois ele converte o objeto passado como argumento para o tipo Reptil
     * Depois compara os atributos do objeto atual com os atributos de outroReptil,
    ...
    /**
     * Método toString que irá imprimir todas as informações do Reptil
     */

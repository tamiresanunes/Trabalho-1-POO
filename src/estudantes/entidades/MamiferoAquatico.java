...
/**
 * Classe MamíferoAquatico que é um tipo de Mamífero, o qual por sua vez é um
 * tipo de Animal
 */
public class MamiferoAquatico extends Mamifero {
    /**
     * Limite de paciência de uma MamiferoAquatico esperando na fila
     * em segundos
     */
    public int PACIENCIA_MAXIMA = 40;

    /**
     * Construtor completo de MamiferoAquatico
     * Todos os atributos saõ passados como parâmetros
     * 
     * @param id
     * @param nome
     * @param especie
    ...
    /**
     * Método que retorna que o MamiferoAquatico está nadando
     * 
     * @return nadando
     */
    ...
    /**
     * Método toString que irá imprimir as informações do MamíferoAquatico
     */
